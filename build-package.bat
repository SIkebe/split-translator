...
powershell -Command "& { $size = (Get-Item 'dist\split-translator.zip').Length; if ($size -gt 10485760) { Write-Host '[ERROR] Package size exceeds 10MB limit!' -ForegroundColor Red; exit 1 } }"
